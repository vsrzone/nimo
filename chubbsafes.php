		...
		<div class="row">
			<div class="col-xs-3">
				<ul>
					...
					<a href="chubsafes.php"><li class="side-menu side-menu-selected">Chub Safes</li></a>
					<a href="chubsafes.php"><li class="side-menu">Fulcrum</li></a>
					<a href="chubsafes.php"><li class="side-menu">Vitra</li></a>
					<a href="chubsafes.php"><li class="side-menu">Herman Miller</li></a>
				</ul>
			</div>
			<div class="col-xs-9">
