		...
		<div class="row">
			<div id="top-banner">
				...
				<div id="page-title-wrapper">
					<p id="page-title">Our Clients</p>
					<p id="breadcrums"><a href="clients.php" target="_self">Clients</a></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="product-info">
					<ul>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client.png" alt="aviva" title="aviva" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client1.png" alt="aviva" title="boc" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client2.png" alt="aviva" title="HSBC" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client4.png" alt="aviva" title="ColomboJwelleryStore" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client1.png" alt="aviva" title="aviva" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client2.png" alt="aviva" title="boc" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client4.png" alt="aviva" title="HSBC" width="100%" height="auto"></div></a></li>
						<li class="brand"><a href="aviva.php" target="_self"><div class="brand-img-wrapper"><img src="images/clients/client.png" alt="aviva" title="ColomboJwelleryStore" width="100%" height="auto"></div></a></li>
					</ul>
				</div>
			</div>
		</div>
